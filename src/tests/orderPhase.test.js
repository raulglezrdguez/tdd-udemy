...
describe("App", () => {
  test("topping header is not in the summary page if not toppings are ordered", async () => {
    render(<App />);
    ...
    // toppings not to be in the document
    ...
    let loadingText = screen.getByText(/loading.../i);
    ...
    // "loading..." appears then disappears
    loadingText = screen.queryByText(/loading.../i);
